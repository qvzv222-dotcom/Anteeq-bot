...
async def access_control_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if len(parts) < 2:
        await update.message.reply_text(
            ...
            "1.1. ⏰ Выдать мут: <i>мут, размут</i>\n"
            "1.2. ⚠️ Выдать предупреждение: <i>пред, варн</i>\n"
            "1.3. 🔨 Выдать бан: <i>бан, разбан</i>\n\n"
            "🟡 <b>РАЗДЕЛ 2: Система ников</b>\n"
            "2.1. ✏️ Установить себе ник: <i>+ник</i>\n"
            "2.2. 🗑️ Удалить себе ник: <i>-ник</i>\n"
            "2.3. 📝 Установить ник участнику: <i>+ник другому</i>\n"
            "2.4. ❌ Удалить ник участнику: <i>-ник другому</i>\n\n"
            "🟢 <b>РАЗДЕЛ 3: Информирование</b>\n"
            "3.1. 📋 Узнать правила: <i>правила</i>\n"
            "3.2. ✍️ Изменить правила: <i>+правила</i>\n"
            "3.3. 👋 Сообщение приветствия: <i>приветствие</i>\n"
            "3.4. 📢 Изменить приветствие: <i>+приветствие</i>\n"
            "3.5. 👨‍💼 Список администраторов: <i>кто админ</i>\n\n"
            "🔵 <b>РАЗДЕЛ 4: Администраторские</b>\n"
            "4.1. 🛡️ Доступ к командам: <i>дк</i>\n"
            "4.2. 🔗 Разрешить ссылки: <i>дк ссылки [ранг]</i>\n\n"
            "🟣 <b>РАЗДЕЛ 5: Система вознаграждения</b>\n"
            "5.1. 🏆 Выдача наград: <i>!наградить {награда}</i>\n"
            "5.2. ✂️ Снятие наград: <i>!снять награды</i>\n"
            "5.3. 🎖️ Посмотреть награды: <i>Наградной список</i>\n"
            "5.4. 🎯 Изменить ранг награждения: <i>дк награды [ранг]</i>\n\n"
            "📊 <b>Система рангов (0-5)</b>\n"
            "0️⃣ - Участник\n"
            "1️⃣ - Модератор чата\n"
            "2️⃣ - Наборщик\n"
            "3️⃣ - Заместитель главы клана\n"
            "4️⃣ - Глава клана\n"
            "5️⃣ - Глава альянса",
            parse_mode='HTML'
        )

...
1. Любое агрессивное/неадекватное/провокационное поведение, подстрекательство к нарушению правил, разжигание конфликтов. <i>[мут]</i>

2. Флуд (от 3-х сообщений): бессмысленные сообщения (набор букв, капса, стикеров, медиа и т.п.), флуд командами бота и чрезмерное использование реакций. <i>[мут]</i>

3. Использование свастики и других обозначений и/или упоминаний запрещённых организаций и/или движений. <i>[пред]</i>

4. Распространение персональных данных без согласия субъекта. <i>[пред]</i>

5. Обсуждение действий администрации и модераторов чата. <i>[мут]</i>

6. Мошеннические проекты, предложения покупки и продажи игровой валюты в обход официального способа, реклама без согласования с администрацией. <i>[бан]</i>

7. Вызов состава модераторов без причины и ложные теги. <i>[мут]</i>

8. Дискредитация руководящего состава. <i>[мут]</i>

9. Намеренное нарушение и игнорирование замечаний/правил. <i>[пред]</i>

10. Пропаганда и обсуждение наркотиков, алкоголя, табакокурения. <i>[мут]</i>

11. Пропаганда гейства, нетрадиционных ориентаций и т.п. <i>[мут]</i>

12. Обсуждение религии или политики в чате. <i>[мут]</i>

13. Контент не подходящий большей части целевой аудитории (18+). Треш/шок/эротический контент. <i>[пред]</i>

14. Запрещены аккаунты, содержащие любого вида порнографию. <i>[пред]</i>
